...
function Onboarding03() {
  ...
  const callUpdate = async () => {
    try {
      const res = await axios.post(`${Config.ApiDomain}/user/update`, {
        data:{
          name,
          companyName
        }
      ...
      console.log(res);
      window.location.href = "/onboarding-04"
          ...
          <div className="min-h-screen h-full flex flex-col after:flex-1">
            ...
            <div className="px-4 py-8">
              <div className="max-w-md mx-auto">
                ...
                <h1 className="text-3xl text-slate-800 font-bold mb-6">General Information ✨</h1>
                {/* htmlForm */}
                <form>
                  <div className="space-y-4 mb-8">
                    {/* User Name */}
                    <div>
                      <label className="block text-sm font-medium mb-1" htmlFor="company-name">User Name <span className="text-rose-500">*</span></label>
                      <input onChange={(e) => setName(e.target.value)} id="company-name" className="form-input w-full" type="text" />
                    </div>
                    {/* Company Name */}
                    <div>
                      <label className="block text-sm font-medium mb-1" htmlFor="company-name">Company Name <span className="text-rose-500">*</span></label>
                      <input onChange={(e) => setCompanyName(e.target.value)} id="company-name" className="form-input w-full" type="text" />
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div
                    onClick={callUpdate}
                     className="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-auto" to="/onboarding-04">Next Step -&gt;</div>
                  </div>
                </form>
