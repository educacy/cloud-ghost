          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-8">
              ...
              <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <div className="w-80">
                  <h2 className="text-2xl text-slate-800 font-bold mb-6">Cloud Services</h2>
                  <DropdownFull optionsFromParent={[
                    {
                      id: 0,
                      period: 'Computer Services'
                    },
                    {
                      id: 1,
                      period: 'Database Services'
                    },
                    {
                      id: 2,
                      period: 'API and Gateway Services'
                    },
                    {
                      id: 3,
                      period: 'Certificate Manager'
                    }
                  ]} />
                </div>
