...
function OrdersTable({
  ...
  useEffect(() => {
    ...
    const getData = async() => {
      const res = await axios.get(`${Config.ApiDomain}/query/aws/cost-acc-daily`);
  ...
  return (
    <div className="bg-white shadow-lg rounded-sm border border-slate-200 relative">
      <header className="px-5 py-4">
        <h2 className="font-semibold text-slate-800">Daily Cost by Account for 60 Days<span className="text-slate-400 font-medium">442</span></h2>
      </header>
      <div>
          ...
          <table className="table-auto w-full divide-y divide-slate-200">
            ...
            <thead className="text-xs uppercase text-slate-500 bg-slate-50 border-t border-slate-200">
              <tr>
                ...
                <th className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                  <div className="font-semibold text-left">Net Amortized Cost</div>
                </th>
                <th className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                  <div className="font-semibold text-left">Net Blended Cost</div>
                </th>
                <th className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                  <div className="font-semibold text-left">Total Usage Amount</div>
                </th>
                <th className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
              ...
              list.map(order => {
                return (
                  <Orders
                    ...
                    date={order.net_amortized_cost_amount || "-"}
                    customer={order.net_unblended_cost_amount}
                    total={order.usage_quantity_amount}
