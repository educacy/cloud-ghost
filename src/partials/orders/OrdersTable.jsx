...
function OrdersTable({
  ...
  useEffect(() => {
    ...
    const getData = async() => {
      const res = await axios.get(`${Config.ApiDomain}/query/aws/compute-instance-monitoring-disabled`);
  ...
  return (
    <div className="bg-white shadow-lg rounded-sm border border-slate-200 relative">
      <header className="px-5 py-4">
        <h2 className="font-semibold text-slate-800">Instances whose detailed monitoring is not enabled <span className="text-slate-400 font-medium">442</span></h2>
      </header>
      <div>
